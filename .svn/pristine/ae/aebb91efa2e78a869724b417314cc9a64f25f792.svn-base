 ...
 * 
 */
public final class NissanEmailUtil {

	private final Logger logger = Logger.getLogger(NissanEmailUtil.class);
...
//		java.util.Properties props = System.getProperties();
	...
	public static boolean send(String from, String to, String subject,
		...
		Logger logger = Logger.getLogger(NissanEmailUtil.class);
	...
	public static boolean sendWithCC(String from, String to, String subject,
		...
		try {
			msg.setFrom(new InternetAddress(from));
			msg.addRecipient(Message.RecipientType.TO, new InternetAddress(to));
			//# get back this for testing purposes for now
	...
	public static void setMailerUserName(String mailerUserName) {
		NissanEmailUtil.mailerUserName = mailerUserName;
	}

	public static void setMailerPassword(String mailerPassword) {
		NissanEmailUtil.mailerPassword = mailerPassword;
	}
	
	public static void connectDefault() {
//		connect("smtp.gmail.com", 587);
		connect("smtp.gmail.com", 587, "noreply@ivant.com", "noreplywtg2009");
	}
	
	public static void connectViaSystemSender() {
		connect("smtp.gmail.com", 587, "system-sender@ivant.com", "ivant#Technolo631-8154!");
	}
	
	public static void connectViaNoreply() {
		connect("smtp.gmail.com", 587, "noreply@ivant.com", "noreplywtg2009");
	}
