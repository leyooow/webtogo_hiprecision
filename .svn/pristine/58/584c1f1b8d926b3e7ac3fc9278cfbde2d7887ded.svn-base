...
public final class EmailUtil {
	...
	public static final String[] OTHER_USERNAMES = {"system@ivant.com","system-sender@ivant.com","system-sender2@ivant.com","system-sender3@ivant.com"};
	public static final String[] OTHER_PASSWORDS = {"ivant#Technolo8154$!","iv@ntTechno631-8154;!","iv@ntTechNoLoGies8154;!","iv@ntTechnoLoGies6318154;?!"};
	public static final String DEFAULT_USERNAME = "system@ivant.com";
	public static final String DEFAULT_PASSWORD = "ivant#Technolo8154$!";
	/*public static final String DEFAULT_USERNAME_SECOND = "system-sender@ivant.com";
	public static final String DEFAULT_PASSWORD_SECOND = "iv@ntTechno631-8154;!";*/
	...
	public static void connectViaWebtogo()
	{
		try{
			connect("smtp.gmail.com", 25, DEFAULT_USERNAME, DEFAULT_PASSWORD);
		}catch(Exception e){
			e.printStackTrace();
	...
	public static void connect(String smtpHost, int smtpPort){
		...
		connect(smtpHost,smtpPort,DEFAULT_USERNAME,DEFAULT_PASSWORD);
	}
...
//		java.util.Properties props = System.getProperties();
	...
	public static boolean sendWithHTMLFormatWithCCFromLife(String from, String[] toEmails,
			String subject, String content, String attachment) {
		hasHTMLContent = true;
		return sendWithCCFromLife(from, toEmails, subject, content, attachment);
	}
	...
	public static boolean send(String from, String to, String subject,
		...
		if(!excluded){
			...
			flag = false;
			logger.info("this email is marked as spam");
		}
	...
	/**
	 * Send email with carbon copy from life
	 *
	 * @param from the sender
	 * @param toEmails the recipient(s), first email to be the direct recipient
	 * @param subject the subject
	 ...
	 * @param attachment attachment path if any, otherwise null
	 */
	public static boolean sendWithCCFromLife(String from, String[] toEmails, String subject,
			String content, String attachment) {
		boolean flag = true;
	...
	public static boolean sendManyAttachments(String from, String to, String subject,
			String content, String[] attachment) {
		boolean flag = true;
		//System.out.println("inside sendManyAttachments : "+ from +" : "+ to + ": Subject : "+ subject +"...");
		MimeMessage msg = new MimeMessage(session);
		try {
			msg.setFrom(new InternetAddress(from));
			msg.addRecipient(Message.RecipientType.TO, new InternetAddress(to));
			...
			//System.out.println("BEfore sending transport....");
			Transport.send(msg);
			//System.out.println("After sending transport....");

		} catch (AddressException e) {
			flag = false;
			e.printStackTrace();
			//System.out.println("address exception for : "+to+" : "+e);
		} catch (MessagingException e) {
			flag = false;
			e.printStackTrace();
			//System.out.println("messaging exception for : "+to+" : "+e);
		} catch (Exception e) {
			flag =false;
			e.printStackTrace();
			//System.out.println(" exception for : "+to+" : "+e);
		}
	...
	public static void setMailerUserName(String mailerUserName) {
		EmailUtil.mailerUserName = mailerUserName;
	}

	public static void setMailerPassword(String mailerPassword) {
		EmailUtil.mailerPassword = mailerPassword;
	}
