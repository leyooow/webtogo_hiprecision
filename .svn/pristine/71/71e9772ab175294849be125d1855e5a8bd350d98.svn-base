 ...
 */
public abstract class AbstractNwdiDAO<T extends BaseID<ID>, ID extends Serializable> implements DAO<T, ID>
{
	private static final Logger log = Logger.getLogger(AbstractNwdiDAO.class);
	...
	public AbstractNwdiDAO(Order ... orders)
	{
	...
	{
		Session session = NwdiHibernateUtil.currentSession(); 
		return session;
	}
	...
	{
		NwdiHibernateUtil.closeSession();
	}
