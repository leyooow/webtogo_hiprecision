 ...
 * 
 */
public final class LifeEmailUtil {

	private final Logger logger = Logger.getLogger(LifeEmailUtil.class);
...
//		java.util.Properties props = System.getProperties();
	...
	public static boolean send(String from, String to, String subject,
		...
		Logger logger = Logger.getLogger(LifeEmailUtil.class);
	...
	public static void setMailerUserName(String mailerUserName) {
		LifeEmailUtil.mailerUserName = mailerUserName;
	}

	public static void setMailerPassword(String mailerPassword) {
		LifeEmailUtil.mailerPassword = mailerPassword;
	}
