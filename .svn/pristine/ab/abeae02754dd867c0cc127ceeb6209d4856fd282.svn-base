...
<c:if test="${company.id==199}">		
			...
			<input type="hidden" name="allowedFields" value="Address"/>
			<input type="hidden" name="allowedFields" value="Email"/>
			<input type="hidden" name="allowedFields" value="Tel. No."/>
			<input type="hidden" name="allowedFields" value="Mobile No."/>
			<input type="hidden" name="allowedFields" value="Fax No."/>
		<input type="hidden" name="submissionId" value="${param.submissionId}"/>		 
</c:if>
