...
<c:set var="submenu" value="member_logs"/>
<c:set var="pagingAction" value="memberLogs.do" />
    ...
    <div class="content">
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="8" class="companiesTable">
					<tr class="headbox"> 
									...
									<c:forEach items="${memberLogList}" var="cp"  varStatus="counter">
