...
currentUploads++;
if (currentUploads>max)
return;

if (currentUploads>0)
document.getElementById('addupload').childNodes[0].data='Attach another image';
...
//var newFields = document.getElementById('attachment').cloneNode(true);javascript:addUpload(2, 'alt', 'upload');
...
if (currentUploads==0)
document.getElementById('addupload').childNodes[0].data='Attach an image ';
