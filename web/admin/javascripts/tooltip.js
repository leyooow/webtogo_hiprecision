...
config. BgColor			= '#e2f6ef'	// Background colour (HTML colour value, in quotes)
config. BgImg			= ''		// Path to background image, none if empty string ''
config. BorderColor		= '#88d4ba'
...
{
	var sCss = 'position:relative;margin:0px;padding:0;border-width:0px;left:0px;top:0px;line-height:normal;width:auto;',
