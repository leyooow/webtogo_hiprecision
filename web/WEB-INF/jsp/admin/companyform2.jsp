			...
			<td width="60%" valign="top">
				...
				<table style> 
					...
					<tr>
						...
						<td nowrap><input type="text" id="company_name" name="company2.name"  <c:if test="${company2.id != null}">disabled="disabled" </c:if> value="${company2.name}" class="textbox4">
					...
					<tr>
						...
						<td nowrap><input type="text" id="name_editable" name="company2.nameEditable" value="${company2.nameEditable}" class="textbox4">
							<font color="red">* &nbsp;</font>
						</td>
					</tr>
					<tr> 
						...
						<td nowrap>	<input type="text" id="company_email" name="company2.email" value="${company2.email}" class="textbox4" />								
							<font color="red">* &nbsp;</font>							
						</td>
					</tr>					
					...
					<tr> 
						...
						<td nowrap="nowrap"><input type="text" id="company_address" name="company2.address" value="${company2.address}" class="textbox4" />
							<font color="red">* &nbsp;</font>
						</td>
					</tr>
					...
					<tr> 
						...
						<td><input type="text" name="company2.address2" value="${company2.address2}" class="textbox4" /></td>
					</tr>
					...
					<tr> 
						<td nowrap>Phone</td>
						<td nowrap="nowrap"><input type="text" id="company_phone" name="company2.phone" value="${company2.phone}" class="textbox4" />
							<font color="red">* &nbsp;</font>
						</td>
					</tr>
					...
					<tr> 
						...
						<td><input type="text" name="company2.cellphone" value="${company2.cellphone}" class="textbox4" /></td>
					</tr>
					
					<tr> 
						<td nowrap>Fax</td>
						<td><input type="text" name="company2.fax" value="${company2.fax}" class="textbox4" /></td>
					</tr>
<%-- 				<tr>
						<td nowrap>State</td>
...
--%>						
					<tr> 
						...
						<td nowrap="nowrap"><input type="text" id="contact_person" name="company2.contactPerson" value="${company2.contactPerson}" class="textbox4" />
							<font color="red">* &nbsp;</font>
						</td>
					</tr>
					...
					<tr> 
						...
						<td nowrap="nowrap"><input type="text" id="contact_person_designation" name="company2.contactPersonDesignation" value="${company2.contactPersonDesignation}" class="textbox4" />
						</td>
					</tr>					
					<tr>
						<td colspan="2" > </td>
			...
			<c:if test="${user.userType == 'Super User' or user.userType =='WTG Administrator'}">
				<div id="uploadimageform">
					<table width="100%" cellpadding="0" cellspacing="2" >
						...
						<table>
									...
									<tr>
										...
										<td>
											<input type="checkbox" name="directToClientFilter" value="true" onchange="showToMainFilterField(this);matchTextfield('newCompanyForm','directToClientFilter','company2.companySettings.hasPalAccount','');" ${directToClientFilter? 'checked="checked"' : ""}<c:if test="${company2.companySettings.hasPalAccount eq true}"> checked</c:if>  />
					...
					<div id="toMainFilterDiv" ${ directToClientFilter ? 'style="display:none"' : 'style="display:block"' } class="aaaa">
				<table style> 
					<tr class="headbox" align="left">
				...
				<c:if test="${user.userType == 'Super User' or user.userType =='WTG Administrator'}">		
 				<table >
					...
					<tr> 
						...
						<td nowrap><input type="text" id="domain_name" name="company2.domainName" value="${company2.domainName}" class="textbox4" />
						<font color="red">* &nbsp;</font>
						</td>
					</tr>
					<tr> 
						<td nowrap>Server Name</td>
						<td nowrap><input type="text" id="server_name" name="company2.serverName" value="${company2.serverName}" class="textbox4" />
				<!-- 		<font color="red">* &nbsp;</font>    -->
						</td>
					</tr> 					 
					<tr>
	 				...
	 				<tr> 
						...
						<td><input type="text" id="monthly_charge" name="company2.companySettings.monthlyCharge" value="${company2.companySettings.monthlyCharge}"  class="textbox4" /></td>
						</tr>
						<tr>
							<td colspan="2">
								<table align="center">
