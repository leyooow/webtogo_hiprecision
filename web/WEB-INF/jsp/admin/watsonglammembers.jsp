...
<div class="contentWrapper" id="contentWrapper">
    ...
    <div class="mainContent">
	  ...
	  <div class="downloadsBox"> 
		...
		<form action="watsonglammembers.do" method="post">
			<table width="100%">
				<tr>
					<td>Date From:</td>
					<td>
		...
		<table>
			<tr>
				<form action="downloadWatsonGlamMemberDetails.do" method="post" name="downloadForm" >
	  ...
	  <div class="clear"></div>
 	  ...
 	  <table width="100%" border="0" cellspacing="0" cellpadding="8" class="companiesTable">
						...
						<c:forEach items="${watsonGlamResults }" var="wr">
