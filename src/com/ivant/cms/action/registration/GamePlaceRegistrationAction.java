...
public class GamePlaceRegistrationAction extends AbstractBaseRegistrationAction{

	public GamePlaceRegistrationAction(){
	...
	public void initializeCompany(){
		...
		requiredMemberInfo.put("Phone", request.getParameter("Mobile Nos."));
		
		//this is set for the subject and body of the email
		requiredMemberInfo.put("Subject", "REGISTRATION: GamePlace Philippines");
		requiredMemberInfo.put("Message", "" +
				"Thank You! You have succesfully registered to GamePlace Philippines" +
			"\nThis is your username: "+request.getParameter("Username")+" and password: "+ request.getParameter("Password")+
